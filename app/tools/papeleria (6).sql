...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-06-2024 a las 04:41:00
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_INSERTAR_PRODUCTOS` (IN `_descripcion` VARCHAR(200), IN `_unidades` INT(25), IN `_codigo_producto` INT(50), IN `_imagen` TEXT, IN `_precio_compra` INT(20), IN `_precio_venta` INT(20))   BEGIN
...
DROP PROCEDURE IF EXISTS `SP_PRODUCTO_PRECIOS`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_PRODUCTO_PRECIOS` ()   BEGIN
SELECT descripcion, precio_venta AS Precio FROM producto;
END$$
...
(20, 'carton cuadrado que tiene puntas delgadas', 333, 1200, '1300', 123445, 0),
(21, 'e222222222222e2eeeeee', 1234, 234567, 'nll', 9000, 80000);
...
--
ALTER TABLE `categorias`
  MODIFY `idCategorias` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `producto`
  MODIFY `idProducto` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
