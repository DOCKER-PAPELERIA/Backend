...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-06-2024 a las 18:42:58
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_EDITAR_USUARIO` (IN `_idUsuario` INT(10), IN `_identificacion` VARCHAR(15), IN `_nombres` VARCHAR(50), IN `_telefono` INT(15), IN `_fecha_naci` DATE, IN `_correo` VARCHAR(100), IN `_contrasena` VARCHAR(500), IN `_estado` VARCHAR(50))   BEGIN
UPDATE usuario
SET identificacion =
CASE
...
(29, 2, 29, 1, 22, '2024-06-26'),
(36, 2, 29, 1, 50, '2024-06-26'),
(40, 12, 2, 1, 22, '0000-00-00');
...
(2, 2, 2, 'Cuaderno argollado', 28, 43, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ02HbBhR9Mf6bNmoJnsuHn2iAfdtQuoaCv2w&s', 3000, '2024-06-10', 'disponible'),
...
(22, 1, 1, 'cuadernos', 25, 2147483647, 'https://www.google.com/imgres?q=imagenes%20de%20productos%20de%20papeleria&imgurl=https%3A%2F%2Fwww.panafargo.com%2Fwp-content%2Fuploads%2F2018%2F08%2F50-arti%25CC%2581culos-de-papeleria-Karin.jpg&imgrefurl=https%3A%2F%2Fpanafargo.com%2F50-articulos-de-papeleria%2F&docid=VWxY170qa1HawM&tbnid=CMM8MNXuBaDlvM&vet=12ahUKEwiazc_7k-aGAxWwq4QIHdYaCqw4ChAzegQIFhAA..i&w=980&h=1139&hcb=2&ved=2ahUKEwiazc_7k-aGAxWwq4QIHdYaCqw4ChAzegQIFhAA', 14000, '2024-06-25', 'disponible'),
...
(29, 2, 5, 'Cartulina tamaño carta', 150, 123456789, 'null', 200000, '2024-06-25', 'disponible'),
...
(1, 1, 12313131, 'c', '12345678', '2004-02-17', 'lodjnbd@gmail.com', '1234', 'activos'),
...
(19, 1, 222222, 'jhaon cachon', '30205000', '1999-02-05', 'v', '$2b$04$C8dD9I22Tm2mOF/O9wj1aO9icBPQp57b3tFExnhPq8XRCTceON8.6', 'inactivo');
...
--
ALTER TABLE `factura`
  MODIFY `idFactura` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
...
ALTER TABLE `factura`
  ...
  ADD CONSTRAINT `Factura_ibfk_3` FOREIGN KEY (`idProducto`) REFERENCES `producto` (`idProducto`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `metodopago` FOREIGN KEY (`idMetodoPago`) REFERENCES `metodopago` (`idMetodoPago`) ON DELETE NO ACTION ON UPDATE CASCADE;
