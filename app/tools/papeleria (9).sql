...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-06-2024 a las 04:12:10
...
(83, 1, 1, 1, 23, '0000-00-00'),
(84, 1, 1, 1, 10, '0000-00-00');
...
(1, 1, 3, 'Lapicero azul ', 40, 44, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQeB7ccJX8-082BMgA_ueorNcTlEEU2PAL5lw&s', 1500, '2024-06-12', 'disponible'),
...
--
ALTER TABLE `factura`
  MODIFY `idFactura` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
