...
CREATE  PROCEDURE `SP_CREAR_HISTORIAL2` (IN `_nombres` VARCHAR(250), IN `_nombreProducto` VARCHAR(250), IN `_tipopago` VARCHAR(250), IN `_cantidad` INT(100), IN `_fecha` DATE)   BEGIN
...
CREATE  PROCEDURE `SP_ELIMINAR_HISTORIAL` (IN `_idFactura` INT(10), IN `_correo` VARCHAR(100))   BEGIN
...
CREATE  PROCEDURE `SP_LISTAR_HISTORIAL` ()   BEGIN
    SELECT 
        f.idFactura AS ID,
...
CREATE  PROCEDURE `SP_MOSTRAR_HISTORIAL` (IN `_idFactura` INT(10))   BEGIN
    SELECT 
         f.idFactura AS ID,
        p.nombre_product AS Nombre_Producto,
        u.nombres AS Usuario,
...
CREATE  PROCEDURE `SP_MOSTRAR_METODOPAGO` ()   BEGIN
