...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-06-2024 a las 07:19:43
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_EDITAR_CATEGORIAS` (IN `_IDCATEGORIAS` INT(10), IN `_DESCRIPCION_CATEGORIA` VARCHAR(200), IN `_CATEGORIA` VARCHAR(100), IN `_FECHA` DATE)   BEGIN
UPDATE categorias
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_INSERTAR_CATEGORIA` (IN `_CATEGORIA` VARCHAR(100), IN `_DESCRIPCION_CATEGORIA` VARCHAR(200), IN `_FECHA` DATE)   BEGIN
INSERT INTO categorias (categoria, descripcion_categoria, fecha)
VALUES (_CATEGORIA, _DESCRIPCION_CATEGORIA, _FECHA);
END$$
...
INSERT INTO `categorias` (`idCategorias`, `descripcion_categoria`, `Categoria`, `fecha`) VALUES
(1, 'jajajajajjajajajajaja', 'papels', '2024-05-28'),
(2, 'lalalalololcadbk kbdv', 'Sacapuntas', '2023-04-02'),
(3, 'labvadbvdlbvlelvel', 'Lapiz Rojo', '2023-05-18'),
(4, 'ojfodvkj dhvo dv kj odphdvldvv', 'Colores', '2024-01-03'),
(5, 'dkhvowbvl wev jw vr', 'Cuadernos', '2023-02-09'),
(6, '-vvojwnlw vñknprnvrv', 'Libros', '2022-11-29'),
(9, '-jpwrnvñ rñknprbnñr bnwr', 'Diccionarios', '2023-08-17'),
(10, 'dd,v l vliWVK  OONOWNVO O ', 'COB', '2024-05-28'),
(11, 'd,vow vlj rwovlwr l vr', 'Tijeras', '2024-03-06'),
(12, 'w.vnowev l wovwo vljv', 'CARTUCHOS', '0000-00-00'),
(13, 'dklvnwv mw vinrlj ', 'aaaa', '0000-00-00'),
(15, 'wñnvpwbl wr ljrvobk wv', 'rggeeg', '2024-05-27'),
(18, 'lwkdnvoiwnlv wprhkrb', 'camas', '0000-00-00'),
(19, 'ndoivowe vlje lv e', 'camas', '0000-00-00'),
(20, 'd.vownle wejb', 'camas', '0000-00-00'),
(21, 'sdkj ewl ieffwelbow', 'camas', '2024-05-27'),
(22, 'w.mvkjwe blw l wljlwbkv ,al vl ', 'camas', '2024-05-27'),
(23, 'd.vbkjwbvl wlbvwrvr', 'camas', '2024-05-27'),
(24, 'dvluidbvld vlbovk v oinoweorb', 'camas', '2024-05-27');
...
(11, 'Carpeta de cartón color café ', 0, 900, 1700),
(12, 'e222222222222e2eeeeee', 0, 9000, 80000),
(13, 'Marcadores', 0, 7300, 15000),
(16, 'carton cuadrado que tiene puntas delgadas', 0, 1200, 1300),
(19, 'ggg', 12, 12, 12);
